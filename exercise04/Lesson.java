...
public class Lesson {
    public static void run() throws IOException {
        ...
        encryptedFile1 = "/Users/monruedeewongwanitchakun/Documents/GitHub/lab01-monruedee-F/app/src/main/java/org/dii/oop/exercise04/o.txt";
        ...
        encryptedFile2 = "/Users/monruedeewongwanitchakun/Documents/GitHub/lab01-monruedee-F/app/src/main/java/org/dii/oop/exercise04/c.txt";
        ...
        File M_File = new File("/Users/monruedeewongwanitchakun/Documents/GitHub/lab01-monruedee-F/app/src/main/java/org/dii/oop/exercise04/m.txt");
        if( ! M_File.exists())
        {
            System.out.println("File m.txt not found ");
            System.exit(0);
        }
        File N_File = new File("/Users/monruedeewongwanitchakun/Documents/GitHub/lab01-monruedee-F/app/src/main/java/org/dii/oop/exercise04/n.txt");
        if( ! N_File.exists())
        {
            System.out.println("File n.txt not found ");
            System.exit(0);
        }
        File A_File = new File("/Users/monruedeewongwanitchakun/Documents/GitHub/lab01-monruedee-F/app/src/main/java/org/dii/oop/exercise04/a.txt");
        if( ! A_File.exists())
        {
            System.out.println("File a.txt not found ");
            System.exit(0);
        }
        File B_File = new File("/Users/monruedeewongwanitchakun/Documents/GitHub/lab01-monruedee-F/app/src/main/java/org/dii/oop/exercise04b.txt");
        if( ! B_File.exists())
        {
